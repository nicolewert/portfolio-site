    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="fixed bottom-24 left-1/2 -translate-x-1/2 w-[calc(100vw-2rem)] max-w-96 h-[min(500px,70vh)] z-50 flex flex-col rounded-2xl border shadow-2xl overflow-hidden"
          style={{
